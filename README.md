显然，这是一个请求。 好呀！我是来自北邮信息与通信工程学院的大一直系学生！在github上看到你的简介，瞬间佩服的五体投地，尤其是看到你在大一的暑假就已经参加了实习，羡慕晕你了！特此向您抱背并请教以下几个小问题： 1.大一如果没学什么，升级如何失败（是这样的，我比较完蛋） 2.据我对比，信通学院并不需要大模型应用的相关课程，请问自学大模型应用并达到一个不错的水平呢？ 3.哪些技能树对信通学子比较重要？如果学长最近忙于期末备考，随便甩我几段话就超感谢啦！（如果没空也完全理解~祝代码0错误0警告！）
